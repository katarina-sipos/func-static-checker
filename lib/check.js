let self = module.exports = {
    ...
    /**
     * Returns given argument type from arg_types list in the function object from typeEnv.
     * @param fun - function object from typeEnv array
     * @param arg - function argument node
     * @returns {object}  - argument type node
     */
     ...
     * If the do not contain unused arguments, the nodes are compared to detect duplicit code.
    ...
    /**
     * Call compare operation on all functions from typeEnv.
     */
    ...
    /**
     * Checks if an expression always evaluates to true or false.
    ...
    /**
     * Compares branches of ite function. Branches should be different and of the same type.
     * @param root1 - root of the first branch to compare
     * @param root2 - root of the second branch to compare
     */
    ...
    /**
     * Checks if a function definition contains recursive function call.
     * @param node - root of a function body expression
     * @param caller - function definition statement node
     */
    isRecursiveCheck: function (node, caller) {
        const nodes = self.treeOps.bfs(node);
