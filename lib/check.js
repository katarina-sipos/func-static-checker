let self = module.exports = {
  ...
  compare: function compare(node1,node2) {
    ...
    let leafs1=[];
    self.getAllLeafs(node1.body,leafs1);
    let leafs2=[];
    self.getAllLeafs(node2.body,leafs2);
      ...
      //console.log(leafs1[i].type);
        ...
        if(leafs1[i].type ===leafs2[i].type ){
          ...
          if(leafs1[i].type==='arg'){
            ...
            }else if(leafs1[i].type==='string_const'|| leafs1[i].type==='num_const'|| leafs1[i].type==='bool_const'){
