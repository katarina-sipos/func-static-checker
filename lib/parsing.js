var self = module.exports = {
  parsingAction: function parsingAction(data) {
    ...
    if (tree.rootNode.hasError()) {
      ...
      atom.workspace.addRightPanel({item: myModel})
...
class myView{
  constructor(){
      ...
      //this.element.innerHTML ='<p style="padding: 5em">'+data+'</p>';
  ...
  update(data){
    this.element.innerHTML ='<div style="overflow: auto;max-height: 100%"><p style="padding: 5em;">'+data+'</p><div>';
  }
}
