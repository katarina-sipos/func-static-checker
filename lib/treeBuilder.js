let self=module.exports = {
    ...
    populate: function populate(node) {
        ...
        toVisit.forEach((item, i) => {
            ...
            tree = tree + " " + self.wrap(item.text) + '<sup style="color:blanchedalmond;font-style:oblique"> ' + type+'</sup>';
    ...
    getNodes: function getNodes(node,parent) {
        ...
        if(node!=null){
            ...
            self.forest.push(self.wrap(parent.text) + '<sup style="color:blanchedalmond;font-style: oblique">APP</sup>');
