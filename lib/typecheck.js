 var self = module.exports = {
   ...
   use: function use(arr,app) {
     ...
     //console.log(arr[1].namedChildren.length);
     var type;
    /*for(var c of arr[1].namedChildren){

      //determine_type_of c and compare it with value in
      //found.arg_types
    }*/
  ...
  determineType: function determineType(toResolve) {
    console.log(toResolve.type);
