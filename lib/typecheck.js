...
let self = module.exports = {
    ...
    declare: function declare(statNode) {
        ...
        if (found) {
            self.display.duplicitFunc(statNode[0].text,statNode[0].startPosition,statNode[0].endPosition);
            console.log(statNode[0].startPosition+' , '+statNode[0].endPosition);
            //self.display.error('Function \'' + statNode[0].text + '\' already declared.');
            return;
        }
