  ...
  determineType: function determineType(toResolve,app) {
    ...
    if(toResolve.type=='expression'){
      ...
      //  console.log(toResolve.text);
        ...
        if(app != null && app.type=='function_definition'){
          ...
          found = arr.find( a => a== node.text);
          if(found == null ) display.error('Undefined function argument used in \''+app.text+'\'');
            return 'undefined type';

          // TODO: najst taku funckiu v typeEnv a zistit, ci ten arg je v nej
        }
        if(app==null || app.parent.type=='statement' ){
